...
zp1 <- zp1 + theme_classic() + theme(line = element_blank(), axis.title = element_text(size = 10), axis.text = element_text(size = 10, hjust = 1), plot.title = element_text(size = 12, hjust = 0.5), axis.text.x = element_text(angle = 90, hjust = 1))
zp1 <- zp1 + geom_tile()
